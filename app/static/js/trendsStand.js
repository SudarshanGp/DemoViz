...
function generate_trendsStand(data_in, department, major, gender){
...
function generate_treeStand(data) {
    ...
    'tree.click',
        function(event) {
            ...
            if(event.node.name == "Freshman" || event.node.name == "Sophomore" || event.node.name ==  "Junior" || event.node.name ==  "Senior" || event.node.name ==  "Graduate") {
                ...
                generate_trendsStand(gender_data, department, major, gender);
            }
        }
    );
}